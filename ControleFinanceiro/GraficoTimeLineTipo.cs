...
{
    public partial class GraficoTimeLineTipo : Form
    {
        public GraficoTimeLineTipo()
        {
            InitializeComponent();
        }

        private void GraficoTimeLineTipo_Load(object sender, EventArgs e)
        {
        ...
        private void btnGerarRelatorio_Click(object sender, EventArgs e)
        {
            ...
            reportDataSource.Value = new TimeLineBcl().PesquisaTimeLineTipoLancamento(GeraCriterio());
